import type { PedometerAPI } from "@/modules/module_types/pedometer";

export const pedometer: PedometerAPI = {
  ...
  getStepCount: async (startDate: Date | string, endDate: Date | string) => {
    console.log(`[MOCK] Pedometer getStepCount: ${startDate} to ${endDate}`);
    return { steps: 1000 };
  },
