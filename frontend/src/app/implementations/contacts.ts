// Self-contained contacts implementation backed by localStorage
...
const filterContacts = (
    ...
    if (searchName) {
        ...
        filtered = contacts.filter((contact) => {
            ...
            return (
                fullName.includes(searchLower) || company.includes(searchLower)
            );
        });
    }
...
export const contacts = {
    ...
    presentContactForm: async (
        ...
        const userLastName =
            lastName || prompt('Last Name:', lastName || '') || '';
